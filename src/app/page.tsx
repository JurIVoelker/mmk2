...
export default function StartPage() {
    return (
        <CustomLayout>
            <div
                className="flex flex-col w-full h-full max-h-[100vh] overflow-hidden relative">
                ...
                <div className="w-full flex justify-center gap-16 h-full items-end">
                    ...
                    >
                        <div className="flex flex-col items-center gap-2">
                            <div
                                className="w-16 h-16 bg-brown-light rounded-full flex items-center justify-center hover:bg-brown-light/60">
                                <img src="/assets/icons/trophy.svg" alt="Leaderboard" className="size-8"/>
                            </div>
                    ...
                    <Link href="/" className="flex flex-col items-center gap-2">
                        <div className="flex flex-col items-center gap-2">
                            <div
                                className="w-16 h-16 bg-brown-light rounded-full flex items-center justify-center hover:bg-brown-light/60">
                                <img src="/assets/icons/impressum.svg" alt="Impressum" className="size-8"/>
                            </div>
