    ...
    <CustomLayout className="relative overflow-hidden">
      ...
      <div className={"flex flex-col h-[100svh]"}>
        ...
        <div className="overflow-y-scroll py-8 px-2">
          ...
          <p>
            Alle Aktuellen Informationen, welche verwendet werden geh&ouml;ren
            Rechtlich und Inhaltlich den Nachrichtenkan&auml;len, welche diese
            Inhalte im Internet ver&ouml;ffentlicht haben.
          </p>
