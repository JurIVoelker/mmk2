...
import { cn, ControlEvent } from "@/lib/utils";
...
export default function NewsSwiper({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    evtSource.onmessage = async (event) => {
      const data = event.data as ControlEvent;
      void handleSwipe(data);
    };
