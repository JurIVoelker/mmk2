      ...
      <div className="relative flex ">
        {showFinger && (
          <img
            ...
            width="48"
            alt="touchFingerIcon"
            src="/assets/onboarding/double-tap_11441390.png"
            className="right-1 self-center animate-pulse absolute z-10"
          />
        )}
        <video
...
export default function Onboarding() {
      ...
      case "text2":
        return (
          ...
          >
            ...
            <motion.div className="rounded-2xl w-full border-transparent bg-gradient-to-r from-red-500 via-yellow-300 to-green-500 p-[10px]">
              <TextContent
            ...
            <GameActionButtons onClickFake={() => {}} onClickReal={() => {}} />
          </div>
        );
      case "text":
        return (
          ...
          >
            ...
            <div className="absolute top-120 z-20">
              ...
              <SpeechBubble
                text="Wenn JA: Wischen Sie den Beitrag nach rechts.
      ...
      case "text5":
        return (
          ...
          >
            ...
            <div className="absolute  z-20">
              <SpeechBubble
                text="Dann Kann es auch schon los gehen.
                                                Viel Spaß!"
              ></SpeechBubble>
            </div>
            <motion.div className="rounded-2xl w-full border-transparent bg-gradient-to-r from-red-500 via-yellow-300 to-green-500 p-[10px]">
  ...
  return (
    <CustomLayout className="w-full h-[100svh] flex flex-col items-center justify-center">
      {renderStepContent()}
    </CustomLayout>
  );
}
